...
2. Login: **philip** / `changeme`
3. **Sofort Passwort ändern** unter Profil (oben rechts)

> **⚠ Das Passwort `changeme` steht direkt in `paperless-ngx.nix`** als `PAPERLESS_ADMIN_PASSWORD`. Nach dem ersten Login unbedingt in der Web-UI ändern!
